...
The [iOS AppAuth Library](https://github.com/openid/AppAuth-iOS) implements OAuty and OpenID Connect, where the app receives login responses on HTTPS redirect URIs, registered as iOS universal links.
