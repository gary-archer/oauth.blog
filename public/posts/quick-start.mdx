...
Alternatively, you can follow the <Link href='/posts/how-to-run-the-react-js-spa'>Final SPA Instructions</Link> to run the app's code locally and connect it to cloud-hosted API endpoints. In either case, sign in with one of the test accounts:
...
The app receives login responses on a redirect URI that uses a private-use URI scheme. To run the app on your local computer you can follow the <Link href='/posts/final-desktop-sample-overview'>Final Desktop App Instructions</Link>.
