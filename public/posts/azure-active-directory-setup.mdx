...
This code sample is an exercise to highlight that OAuth implementations should be portable. When an authorization server implements vendor-specific behavior, security libraries may not work out-of-the-box and you may need to apply workarounds.
