...
![code layout](../images/570/code-layout.jpg?v=20240914)
</div>
...
<div className="smallimage">
![concurrent views](../images/570/concurrent-views.jpg?v=20240914)
</div>
...
<div className="smallimage">
![appauth error](../images/570/appauth-error.jpg?v=20240914)
</div>
