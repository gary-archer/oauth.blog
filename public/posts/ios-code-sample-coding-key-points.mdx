...
<div className='smallimage'>
    <img src='../images/570/code-layout.jpg?v=20260627' alt='code layout' />
</div>
...
When the app starts, it loads OpenID Connect metadata and also any tokens from iOS storage. This prevents the user needing to re-authenticate on every application restart. If tokens expire by the time the app restarts, the code reliably copes with that condition.
