...
I denormalise certain error fields to the top level, to enable SQL queries to use error IDs or error codes.
...
You can provide powerful ways for operational staff to resolve code-level problems, and enable qualities like DevOps resolving 80% of production incidents without the need to involve a specialist developer.
