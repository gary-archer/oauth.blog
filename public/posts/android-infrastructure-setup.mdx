...
| www.authsamples.com | I use part of the web domain to host intermediate post-login and post-logout web pages. |
...
I uploaded the assets file to run at the below HTTPS URL, in a similar manner to the intermediate web pages. I use a second S3 bucket and CloudFront distribution for the mobile subdomain:
