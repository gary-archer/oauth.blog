...
At runtime, views populate the *root* element with inner elements. In particular, a *main* child element gets updated with the main view as the user navigates. Views are composed of subviews, arranged via rows and columns, using the [Bootstrap Grid System](https://getbootstrap.com/docs/5.3/layout/grid/). 
