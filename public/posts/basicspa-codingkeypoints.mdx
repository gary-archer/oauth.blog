...
The <a href='basicspa-oauthworkflow'>SPA and API OAuth Messages</a> post explained the initial code sample's HTTP/S messages. In this post I drill into some identity-related code in the SPA.
...
- I explain some <a href='basicapi-codingkeypoints'>API Code Details</a> for the first code sample.
