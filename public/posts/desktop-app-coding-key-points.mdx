...
Previously I summarised some test behavior in <a href='desktop-app-how-to-run-the-code-sample'>How to Run the Desktop Code Sample</a>. I complete the content for the initial desktop app with some code-level details.
...
- I provide a <a href='final-desktop-sample-overview'>Final Desktop Code Sample</a> with some additional behaviors.
