...
An organization that follows this approach can keep its options open and plan many types of deployments, including multi-cloud. It can also use local clusters for some types of development and test environments, to save costs.
