...
Previously I explained this blog's <a href='serverless-api-coding-model.mdx'>Serverless API Code Details</a> to complete this blog's initial cloud deployment. Yet the API side of the architecture could be further improved:

- Serverless APIs may require more complex code and fewer local computer capabilities than cloud native APIs.
