...
| Modern SPA Framework | Avoid getting sidetracked by too much web technology initially, though this blog's <Link href="/posts/final-spa-overview">Final SPA</Link> uses React. |
