...
For this blog's early SPAs I use vanilla TypeScript rather than web frameworks, to reduce JavaScript complexity. Instead, I focus on requirements for OAuth and API integrations, using techniques that would work with any technology stack:
...
On a development computer I almost never develop with URLs like *http://localhost:3000*. Instead, I use real-world domain names and HTTPS for the hosting of APIs and web static content. I use a *-dev* suffix for URLs to represent the local environment.
