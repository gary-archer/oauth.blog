...
This blog's APIs use Node.js 22 or later, with the following *tsconfig.json* configuration. You use some of these settings when you import modules and you use other settings when you build code:
