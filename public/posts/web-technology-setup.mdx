...
You could adapt this blog's SPAs to use an alternative web bundler. I currently prefer webpack over other bundlers, since it is a mature, open source solution that seems to have a strong consumer-focus when you run into deeper requirements.
