...
I explained how to manage a web pipeline on a development computer. Later in this blog I apply some finishing touches to the [web deployment pipeline](cdn-static-content-delivery/) and host the SPA's static content on a content delivery network.
