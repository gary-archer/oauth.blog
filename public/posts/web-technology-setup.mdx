...
One current webpack limitation is that the syntax of the output ECMAScript modules could be cleaner. In future I would like code that runs in the browser to be as close as possible to my original TypeScript code.
