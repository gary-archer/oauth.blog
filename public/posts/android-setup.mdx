...
During login the system browser runs as a [Chrome Custom Tab](https://developer.chrome.com/multidevice/android/customtabs), which renders the AWS Cognito login screen:
...
I showed the basics of running an OAuth-secured mobile app from Android Studio. Shortly I will explain this blog's <a href='android-code-sample-overview.mdx'>Android Code Sample</a>, which demonstrates much more complete OAuth behaviour.
