...
To update the app, navigate to the file at *app/res/raw/auth_config.json* and paste in the values:
...
Note that login redirects use a *Private Use URI Scheme*, with the scheme value from the app's *build.gradle* file::
