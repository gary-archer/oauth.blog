...
<html lang='en'>
    <head>
        ...
        <link rel='stylesheet' href='bootstrap.min.css?t=1768071505199' integrity='sha256-DSheh43UZt7zrMp3qRhx89tu1ohvTPHGj847cgKXIoI='>
        <link rel='stylesheet' href='app.min.css?t=1768071505199' integrity='sha256-XLjpon9xf4GXdXktU8j0Ru2HdHkD/sypdFXKNMFN2+A='>
    </head>
    <body>
        <div id='root' class='container'></div>

        <script type='module' src='vendor.bundle.min.js?t=1768071505199' integrity='sha256-8Szmbvuwj6NZ1o//8WhzB9QVCqLjnMSUbzlpWXp4GAY='></script>
        <script type='module' src='react.bundle.min.js?t=1768071505199' integrity='sha256-Bjli/71wVFSPe9+iYyVFZSFXAj45mrrA0krTP+u0tn4='></script>
        <script type='module' src='app.bundle.min.js?t=1768071505199' integrity='sha256-ByxgW9MSsCXTwQb8gCnMkgNZkyY4/SHGsoK6/IJ1Oxg='></script>
    </body>
</html>
```

A script called *writeProductionAssets.ts* produces the final HTML file while also keeping it readable. This script also removes the below line from release bundle files, to prevent production users ever seeing messages about missing source maps in the browser console:
...
upload: .package/spa/app.min.css to s3://www.authsamples.com/spa/app.css
upload: .package/spa/bootstrap.min.css to s3://www.authsamples.com/spa/bootstrap.min.css
upload: .package/spa/app.bundle.min.js to s3://www.authsamples.com/spa/app.bundle.js
upload: .package/spa/vendor.bundle.min.js to s3://www.authsamples.com/spa/vendor.bundle.js
upload: .package/spa/react.bundle.min.js to s3://www.authsamples.com/spa/react.bundle.js
```
...
![spa subfolder](../images/610/spa-subfolder.jpg?v=20260110)
...
A key point to understand is the separation of concerns. The code that runs within the CDN only manages web concerns and never deals with data security. If the code was to call APIs it would add considerable complexity to both deployment systems and developer setups. AWS is likely to impose short HTTP request timeouts and small message sizes for API calls from Cloudfront functions, which would lead to reliability problems. 
