...
In a previous post I explained <a href='how-to-run-the-react-js-spa.mdx'>How to Run the Final SPA</a>. To deploy to CloudFront I use the following commands, though the deployment requires access to my AWS account:
...
The build script for the final SPA produces a *dist* folder containing static content to deploy. Release JavaScript bundles are minified and use randomized file names. I also use the [purgecss tool](https://github.com/FullHuman/purgecss) to reduce the size of the Bootstrap CSS file. The following screenshot shows the final assets. I do not deploy source map files but in a real system I would save them to help diagnose production stack traces.

<img src='../images/610/release-bundles.jpg?v=20260529' alt='release bundles' />

I produce a final *index.html* file with minimized assets. The randomized file names trigger new downloads after an upgrade. I also apply [subresource integrity](https://developer.mozilla.org/en-US/docs/Web/Security/Subresource_Integrity) attributes, to bind each resource to the HTML file. This may not solve any real security problems for my web deployment, but is a personal preference, to assert the correctness of assets shipped together.
...
<html lang='en'>
    <head>
        ...
        <link rel='stylesheet' href='bootstrap.4d702f0a.css' integrity='sha256-DSheh43UZt7zrMp3qRhx89tu1ohvTPHGj847cgKXIoI='>
        <link rel='stylesheet' href='app.4d702f0a.css' integrity='sha256-wpxzyiZ9mWTR+PUw5uUNfN6T2uaGdKuk0TgnUFwsPyY='>
    </head>
    <body>
        <div id='root' class='container'></div>

        <script type='module' src='vendor.4d702f0a.bundle.js' integrity='sha256-Xr32GpFjvOxN7gfVzL7mTk7dDevf4005XoD0kdnrNQc='></script>
        <script type='module' src='react.4d702f0a.bundle.js' integrity='sha256-dZfGc3TNsav7cYV3lJtIDswxuyzLDTUME0/r/py0phs='></script>
        <script type='module' src='app.4d702f0a.bundle.js' integrity='sha256-7Sd6YKpoVylA3orG0y1wZa0KbJPVL3G9Y9NqrBNdN1o='></script>
    </body>
</html>
```

A Rollup custom plugin named *writeCssAndHtml* handles the [writeBundle](https://rollupjs.org/plugin-development/#writebundle) event to produce the final HTML file while also keeping it readable. A separate custom plugin named *finalizeBundles* handles the [generateBundle](https://rollupjs.org/plugin-development/#generatebundle*) event to remove the below line from release bundles, to prevent production users ever seeing messages about missing source maps in the browser console.
...
upload: .package/spa/app.4d702f0a.css to s3://www.authsamples.com/spa/app.4d702f0a.css
upload: .package/spa/bootstrap.4d702f0a.css to s3://www.authsamples.com/spa/bootstrap.4d702f0a.css
upload: .package/spa/index.html to s3://www.authsamples.com/spa/index.html
upload: .package/spa/vendor.4d702f0a.bundle.js to s3://www.authsamples.com/spa/vendor.4d702f0a.bundle.js
upload: .package/spa/app.4d702f0a.bundle.js to s3://www.authsamples.com/spa/app.4d702f0a.bundle.js
upload: .package/spa/react.4d702f0a.bundle.js to s3://www.authsamples.com/spa/react.4d702f0a.bundle.js
```
...
In AWS I created a CloudFront distribution that maps to the S3 bucket. I then added *www.authsamples.com* as an alternative name and assigned the certificate:
...
These are configured under the *Behaviours* settings of the CloudFront distribution, which can link to CloudFront policies or functions. I created a *Response Headers Policy* and activated compression and most security headers using the visual user interface:
