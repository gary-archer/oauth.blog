...
All of this blog's APIs are non blocking, to prevent threads being tied up during I/O completion. It is standard in .NET these days to be *async all the way*, starting at the controller entry point:
...
public async Task Invoke(HttpContext context, ILogEntry logEntryParam)
{
    ...
    var loggerFactory = context.RequestServices.GetService(typeof(LoggerFactory)) as ILoggerFactory;
