...
The size of each upload zip file is around 200KB and each lambda bundle is around 6400KB. The Serverless framework also adds [CloudFormation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html) artifacts that automate the creation of AWS resources.
