...
```json
{
    ...
    "oauth": {
        ...
        "jwksEndpoint":                 "http://login.authsamples-dev.com/.well-known/jwks.json",
...
I ported this blog's earlier Node.js API to run with low cost and zero maintenance in AWS. This blog's frontend code samples all get their data from the Serverless API, which works well enough for my cloud connected demo apps.
