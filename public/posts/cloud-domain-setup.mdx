...
AWS CloudFront and AWS Cognito both require certificates issued in the North Virginia region. I expressed each subdomain as a certificate subject alternative name and also selected the *Create records in Route 53* option to enable certificate manager to verify my ownership of the domain.
