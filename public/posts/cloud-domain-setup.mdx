...
| *authsamples-dev.com* | A local computer domain that I use when changing the code for the demo applications and APIs. |
| *authsamples-k8s.com* | A cloud domain that runs in AWS and uses Kubernetes hosting for the API side of the architecture. |
| *authsamples-k8s-dev.com* | A local computer domain that I use to practice deployments to Kubernetes clusters. |
