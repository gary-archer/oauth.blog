...
I showed how developers can create low cost HTTPS application URLs in a cloud system. To do so you follow equivalent DNS and SSL technical steps to those that this blog uses on a development computer. You can use serverless building blocks which provide low cost for my online code samples. For a real company you could use cloud native building blocks to get finer control over technical behaviours.
