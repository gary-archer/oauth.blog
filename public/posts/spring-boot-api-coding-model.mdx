...
The main responsibility of these objects is to read the API's JSON configuration and to set up *Cross Cutting Concerns*, including the registration of dependencies:
