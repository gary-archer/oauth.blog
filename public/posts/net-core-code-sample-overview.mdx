...
To do so, follow the instructions, such as using a *LOCALAPI* environment variable to override the default frontend behavior of pointing to a cloud API. When the frontend runs a code flow you can authenticate with this blog's test credential:
