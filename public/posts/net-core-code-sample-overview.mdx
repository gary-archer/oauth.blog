...
Previously I explained the <a href='final-nodeapi-coding-key-points'>Final Node.js API Code Details</a>, including some behaviours from this blog’s <a href='api-journey-server-side'>API Journey – Server Side</a> blog post. Next I provide an equivalent API in C# and .NET.
...
To prevent SSL trust problems from tests or the browser you should <a href='developer-ssl-setup'>Configure .NET and Browser Trust</a> for the root certificate at the following location. 
...
- I explain this blog's <a href='net-core-api-oauth-integration'>.NET API OAuth Integration</a>.
