...
This blog provides APIs developed in the following languages and in each case a [JavaScript Object Signing and Encryption (JOSE)](https://datatracker.ietf.org/wg/jose/about/) library is used, to enable up-to-date security options when needed:
