...
The app has a similar code layout to the initial desktop code sample. The main code represents the Electron main process and the Electron renderer process, along with some shared code. The *build* and *tools* folder manage Rollup builds and live reloading.
