...
I configured the following options in the application's *build.gradle.kts* file, to enable views that use the newer *Jetpack Compose* syntax, which I find easier to maintain than older XML layout views:
