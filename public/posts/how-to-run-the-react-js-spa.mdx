...
Previously I provided a <a href='final-spa-overview'>Final SPA Overview</a> with the main high-level architecture behaviors. Next I show how to run the final SPA on a development computer in a couple of different configurations.
...
The SPA now uses React for its views, which have identical behaviour to those from <a href='basicspa-codingkeypoints/#spa-views'>Earlier SPA Code Samples</a>:
...
The web host uses SSL and downloads some development certificates, so you must ensure that your browser trusts the root certificate at the below location, according to the <a href='developer-ssl-setup#trust-a-root-certificate-in-browsers'>SSL Trust Configuration</a> post.
...
- <a href='api-architecture-node'>Node.js API</a>
- <a href='net-core-code-sample-overview'>.NET API</a>
- <a href='java-spring-boot-api-overview'>Java Spring Boot API</a>
...
- Next I explain some <a href='reactjs-codingkeypoints'>Final SPA Code Details</a>.
