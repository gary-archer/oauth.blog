...
| Client | Behaviour |
| ------ | --------- |
| API | The <Link href='/posts/api-architecture-node'>Final API</Link> post explains how to run a local API setup |
| SPA | The <Link href='/posts/how-to-run-the-react-js-spa'>Final SPA</Link> post explains how to point to a local API |
