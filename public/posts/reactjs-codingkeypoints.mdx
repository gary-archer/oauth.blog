...
The final SPA uses the same format of HTML markup as earlier SPAs:
...
The final SPA uses security hardened settings, and returns a number of security headers. This includes setting a highly restrictive content security policy during development:
