...
The page load handler processes the authorization response and sends it to the OAuth agent. The result is to issue encrypted session cookies, which contain the underlying OAuth tokens, to the browser.
