...
The final SPA uses the Rollup bundler to produce clean ECMAScript bundles whose code runs in the browser. A partial configuration is shown here, and is similar to the webpack configuration from this blog's earlier SPAs. Getting your preferred results typically requires the use of built-in or custom plugins, where you can customize behaviors.
