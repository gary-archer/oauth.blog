...
During development I continue to use the webpack development server. For the final SPA I use additional security settings to use a restrictive content security policy during development:
