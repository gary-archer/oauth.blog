...
The final SPA continues to use this blog's <a href='web-technology-setup.mdx'>Web Technology Setup</a>. That post explains how the SPA uses the rollup bundler to build modern ECMAScript bundles and use an Express HTTP server to serve them. The web development setup uses a restrictive content security policy and live reloading during development.
...
The *App* component uses JSX syntax to initialize a tree of views. These include path-based navigation routes within the SPA's base path.
