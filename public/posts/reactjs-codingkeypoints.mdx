...
The final SPA deals reliably with some tricky areas, in the lower-level plumbing classes. Once written, web developers at a real organization could grow the web code base by adding new view and view model classes. An early focus on security, development setups, deployment, security and reliability supports the valuable future business logic.
