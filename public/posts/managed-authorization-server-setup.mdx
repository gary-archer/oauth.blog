...
Previously I explained this blog's <a href='cloud-domain-setup.mdx'>Cloud Domain Setup</a>. Next I explain some advanced configuration details when using AWS Cognito as an authorization server, which uses *managed*, or *Software as a Service (SaaS)* hosting.
