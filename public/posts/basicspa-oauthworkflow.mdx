...
Most of the time I trace HTTP/S messages using an HTTP development proxy rather than browser tools. This allows me to view traffic from both the SPA and API together. See the <a href='http-debugging-setup.mdx'>HTTP Proxy Setup</a> post if you are new to this type of tool:
