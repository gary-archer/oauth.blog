...
The content is built as a basic NEXT.js blog and stored in [this GitHub repository](https://github.com/gary-archer/apisandclients.com). I can also deploy the blog's static content to AWS CloudFront and deploy it to ~400 global locations, to ensure that it performs well globally.
