...
The content runs as a basic NEXT.js blog. When built, I can deploy its static content to AWS CloudFront and hundreds of global locations, to ensure globally equal performance. The blog runs as a public website and does not use sensitive data or call APIs. For secured web applications I prefer an SPA architecture.
