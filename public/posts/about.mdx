...
The content is built as a basic NEXT.js blog. I can deploy the blog's static content to AWS CloudFront and ~400 global locations, to ensure that it performs well. The blog is a public website and does not use secured data or call APIs. If you read the blog you will see that I prefer a pure SPA approach for web applications that use sensitive data.
