...
The content runs as a basic NEXT.js blog. When built, I can deploy its static content to AWS CloudFront and ~400 global locations, to ensure globally equal performance. The blog runs as a public website and does not use secured data or call APIs. For web applications that use sensitive data I instead prefer to build Single Page Applications.
