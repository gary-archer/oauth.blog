...
![repo](../images/550/repo.jpg?v-20260627)

### Step 2: Open the Project in Xcode

In Xcode the project's Swift code is located in the *src* folder. Run the app on a simulator with your default *Signing and Capabilities* or with empty settings:

![project layout](../images/550/project-layout.jpg?v=20260627)
...
![dependencies](../images/550/dependencies.jpg?v=20260627)
