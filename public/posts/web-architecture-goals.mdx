...
OAuth enables web apps to externalise data protection to APIs, and user authentication to the authorization server. As a result, web developers should never need to implement backend security, which greatly simplifies their responsibilities.
