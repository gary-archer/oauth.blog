...
Previously I ran an initial iOS Setup using the <a href='ios-setup.mdx'>AppAuth iOS Code Sample</a>. Next I explain a way to view HTTPS mobile traffic from iOS simulators and devices on a development computer, to provide a productive troubleshooting setup.
...
I explained an iOS HTTP debugging setup, to enable visualization of OAuth and API requests, which is an essential behavior for productive OAuth client development.
