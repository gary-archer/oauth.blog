...
public async initializeApi(): Promise<void> {
    ...
    this.expressApp.use('/api/*', cors(corsOptions) as any);
    this.expressApp.use('/api/*', this.apiController.onWriteHeaders);

    this.expressApp.use('/api/*', this.catch(this.apiLogger.logRequest));
    this.expressApp.use('/api/*', this.catch(this.apiController.authorizationHandler));
    ...
    this.expressApp.use('/api/*', this.apiController.onRequestNotFound);
    this.expressApp.use('/api/*', this.apiController.onException);
}
```
