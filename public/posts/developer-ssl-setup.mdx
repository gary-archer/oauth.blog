...
Next, run commands to create a second asymmetric private key and public certificate. You use the private key to sign a certificate signing request (CSR) and then request an X509 certificate with the CSR:
