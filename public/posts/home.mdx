...
I first provide my opinions on the most important goals and requirements. I then  explain my preferences for meeting them, with setups that enables anyone new to OAuth to easily run secure end-to-end API and client flows. 
