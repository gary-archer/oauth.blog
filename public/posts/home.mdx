...
I find very limited material on these topics, so I wrote a blog that combines my experience as an architect with my experience as a coder. I start with goals and requirements, then demonstrate my preferred techniques to meet them. Of course there are many possible ways to build solutions from requirements, so you should treat my opinions only as suggestions.
