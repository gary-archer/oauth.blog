...
This blog focuses on productive and reliable code setups when developing APIs, browser based apps and mobile apps within a distributed architecture. Although the use of modern technology stacks may fell straightforward, end-to-end flows require technical foundations before they are production-ready.

The blog combines my experience as an architect with my experience as a coder. I start with goals and requirements, then demonstrate my preferred techniques to meet them. Of course there are many possible ways to build solutions from requirements, so you should treat my opinions only as suggestions.
