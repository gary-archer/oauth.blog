...
This blog explores productive and reliable code setups when developing APIs, browser based apps and mobile apps. Although the use of modern technology stacks may fell straightforward, end-to-end flows require technical foundations before they are production-ready.

I find very limited material on these topics, so I wrote a blog that combines my experience as an architect with my experience as a coder. I start with goals and requirements, then demonstrate my preferred ways to meet them with clean code. Of course there are many possible ways to build solutions from requirements, so you should treat my opinions only as suggestions.
