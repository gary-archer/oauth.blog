...
To enable the reliable use of short-lived, least-privilege access tokens, the app itself should use fetch requests to initiate all API requests for sensitive data. For web applications, this means the web host never calls APIs.
