...
To enable the reliable use of short-lived, least-privilege access tokens, frontend applications should initiate all API requests for sensitive data, using fetch requests. For web applications, this means the web host never initiates calls to APIs.
