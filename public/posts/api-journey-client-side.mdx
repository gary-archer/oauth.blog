...
OAuth clients typically load their configuration at startup, to get details such as API base URLs and OAuth settings. An app that acts as a public client might use configuration settings similar to those shown below:
