...
Then edit the following details in the *flow.ts* module to point the app to my test AWS Cognito client:
...
In the *app.ts* module, use *https://login.authsamples.com/oauth2/userInfo* as the userInfo URL and then edit the *updateUI* function:
