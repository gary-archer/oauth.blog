...
The authorization server should provide an authentication toolbox. During an authorization code flow, the user may perform various other actions in addition to entering authentication methods, such as one or more of those listed below:
