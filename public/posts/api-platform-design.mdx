...
The API flows in this blog serve web and mobile clients and consist of the following components. This type of separation externalizes most security behaviours from application code and also provides applications with the best security features:
