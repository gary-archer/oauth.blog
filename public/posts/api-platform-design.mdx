...
The API hosting platform should enable you to integrate your preferred best of breed supporting components and write code without limitations. Hosting should also be portable so that you can deploy anywhere. I prefer to deploy APIs in a cloud native platform like Kubernetes.
