...
I have summarised some foundations to aim for when designing a modern API platform. In this blog's second theme I provide three cloud native APIs in different technology stacks, with a focus on foundational code:
