...
The main goal of the final desktop app is to improve usability. After OAuth logins the app returns to the foreground, and the app also implements OpenID Connect logout. The app also prevent users needing to re-authenticate every time they restart the app.
