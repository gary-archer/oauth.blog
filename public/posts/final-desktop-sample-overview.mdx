...
If you use your browser's *View Source* option you can see that the pages simply forward the login response to the app's private use URI scheme callback URL:
