...
The protocol scheme is also used as an OAuth private URI scheme, with which the desktop app receives OAuth responses and other deep links from the desktop operating system.
...
I set the app's redirect URIs to external web pages, at the following URLs. These pages also improve a little on the default blank browser page that the user sees after login.
