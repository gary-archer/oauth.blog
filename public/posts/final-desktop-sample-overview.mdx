...
Previously I explained some <a href='desktop-app-coding-key-points'>Code Details</a> for this blog's initial desktop app. Next I add some missing features to complete session management, harden security, and improve usability. The desktop app connects to <a href='cloud-hosting'>HTTPS endpoints hosted in AWS</a>, so that you only need to run the desktop app's code to get a fully integrated solution.
...
- <a href='net-core-code-sample-overview'>.Net Core API</a>
...
- I explain some <a href='final-desktop-app-coding-key-points'>Code Details</a> for the final desktop app.
