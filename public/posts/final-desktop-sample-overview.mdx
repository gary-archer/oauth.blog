...
| Feature | Description |
| ------- | ----------- |
| Technology Modernization | I upgradee from plain TypeScript with webpack to a React app and the rollup bundler. |
...
This command starts two child windows, to build code for the main and renderer processes using the [Rollup](https://rollupjs.org/) bundler, and to run a live reload server that notifies the frontend after code changes.

![child windows](../images/440/child-windows.jpg)
