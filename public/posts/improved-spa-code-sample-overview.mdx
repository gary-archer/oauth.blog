...
### Step 3. Understand the Updated OAuth Client
...
The API and web static content hosting uses SSL so you must create OpenSSL development certificates by running this script:
