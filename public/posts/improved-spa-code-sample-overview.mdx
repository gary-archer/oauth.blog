...
The updated SPA code sample aims to complete OAuth session management in the SPA, while also providing an extensible way to manage authorization claims in APIs.
