...
### Full Stack Development EnvOpenID Connectironment
...
I do not explain the token handler pattern in this blog, but you can study the following resources to understand the SPA's cookie layer. The OAuth Proxy logic should execute in a high performance API gateway:
...
- The wildcard lambda uses the Node.js fetch library to explicitly call *https://api.authsamples.com/investments* with an access token.
