...
- Then the SPA connects to cloud native APIs, it uses a [Cloud Native Token Handler](https://github.com/gary-archer/oauth.tokenhandler.cloudnative) that integrates with a cloud native API gateway.
