...
Previously I explained some <Link href='/posts/logout'>Logout</Link> behaviours. I finish the discussion on SPA session management by describing the role of ID tokens, which are designed to be read by clients rather than APIs.
