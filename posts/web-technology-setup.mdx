...
In the native apps section of this blog I use [Electron](https://www.electronjs.org/) to develop OAuth-secured cross-platform desktop apps. An Electron app can also be built to ECMAScript modules, though doing so is a little tricky to figure out. The <Link href='/posts/desktop-app-coding-key-points'>Desktop App - Code Details</Link> post explains the techniques I use.
