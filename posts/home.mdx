...
Organizations often want to build interactive web and API solutions, to enable a modern and dynamic user experience. It is common to therefore build *Single Page Applications (SPA)*, with a technical focus on frontend development. Later, the organization add mobile apps that use the same APIs. All of this seems straightforward, but end-to-end flows require foundations before the solution is production-ready.
