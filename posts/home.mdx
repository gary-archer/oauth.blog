...
| <span style={{color:'green'}}>**Productive**</span> | Code is readable and cleanly separated so that people understand it and can grow the business logic. |
...
- Enabling <span style={{color:'green'}}>**productivity**</span> due to an investment in developer setups.
