...
Developers sometimes add undue complexity to web applications in efforts to optimize and achieve fast page loads. In some cases remote users, who may be located thousands of miles from the web host and therefore experience poor performance. The best way to resolve this type of problem is to get foundations right using standard solutions.
