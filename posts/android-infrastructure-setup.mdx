...
| <span style={{color:'green'}}>**www.authsamples.com**</span> | We use the web domain for ad-hoc hosting of basic web pages, including interstitial post-login and post-logout web pages |
...
![verification success](/images/520/verification-success.jpg)
...
![verification failure](/images/520/verification-failure.jpg)
...
- Next I provide an <Link href='/posts/android-coding-key-points'>Android Code Details</Link>
