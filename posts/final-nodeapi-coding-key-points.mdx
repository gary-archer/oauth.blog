...
Our coding model has changed a fair amount since the previous API sample, and this includes use of [InversifyJS](https://github.com/inversify/InversifyJS) to manage object creation and lifetimes:
