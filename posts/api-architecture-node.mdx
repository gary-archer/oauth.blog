...
The *run.sh* script executes a number of commands in child terminals, to run the default browser at https`:`//web.authsamples-dev.com/spa. You can then sign into the SPA using this blog’s test credential:
