...
Previously I summarised some test behavior in <Link href='/posts/desktop-app-how-to-run-the-code-sample'>How to Run the Desktop Code Sample</Link>. I complete the content for the initial desktop app with some code-level details.
...
The initial desktop app simply stores the tokens in-memory. Every time the app restarts the user is prompted to re-login. I show how to improve this user experience in the final desktop code sample.
