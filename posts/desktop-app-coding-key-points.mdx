# Desktop App – Code Overview

Previously we explained <Link href='/posts/desktop-apps-overview'>How to Run the Desktop Code Sample</Link>, which included some test scenarios. We will complete the posts for the initial Electron desktop app by describing some code-level details.
...
### Customising the Authorization Handler
