...
| Domain | Usage |
| ------ | ----- |
| <span style={{color:'green'}}>**web.authsamples.com**</span> | Serving web content for an online SPA that connects to Serverless APIs |
| <span style={{color:'green'}}>**web.authsamples-k8s.com**</span> | Serving web content for an online SPA that connects to Kubernetes APIs |
...
- http`:`//web.authsamples.com.s3-website.eu-west-2.amazonaws.com
