...
- https`:`//web.authsamples.com/spa1
- https`:`//web.authsamples.com/spa2
- https`:`//web.authsamples.com/spa3

### SPA Deployment

The SPA deployment model simply involves copying built web resources to a *web.authsamples.com* S3 bucket:
