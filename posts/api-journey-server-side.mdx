...
Previously we summarised this blog’s <Link href='/posts/api-platform-design'>API Platform Overview</Link>. Next we will take a closer look into some desired technical behaviours for APIs, as implemented by this blog’s final API code samples:
