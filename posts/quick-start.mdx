...
The SPA is deployed to many global locations using AWS Cloudfront. Anyone can run the app via the below link. To run the app locally you can follow the <Link href='/posts/how-to-run-the-react-js-spa'>Final SPA Instructions</Link>.
