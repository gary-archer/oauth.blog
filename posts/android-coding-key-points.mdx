...
<div className="smallimage">
![concurrent views](/images/530/concurrent-views.jpg?v=20240912)
</div>
...
Upon return from login an interstitial page runs in the Chrome custom tab window. This screen receives the authorization code in a response query parameter. JavaScript code in the web page invokes the login receiver activity when the continue button is pressed. This forwards any received query parameters, including the authorization code, to the app:
...
<div className="smallimage">
![appauth error](/images/530/appauth-error.jpg?v=20240912)
</div>
