...
The above code demonstrates *deep linking*, where a user bookmarks a location like *http://localhost/spa/#company=2*, then access it in a new browser session. After signing in, the user returns to their bookmarked location.
