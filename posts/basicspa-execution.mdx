...
Both AWS Cognito and the crypto in the oidc-client-ts library require the SPA to use a localhost domain name when using HTTP URLs. In future code samples I will update to HTTPS URLs and use a web domain of *web.mycompany.com*.
