...
```markdown
127.0.0.1 apilocal.authsamples-dev.com login.authsamples-dev.com web.authsamples-dev.com
```
...
This will run a number of commands in child terminals, the last of which runs the default browser at https`:`//web.authsamples-dev.com/spa. You can then sign into the SPA using this blog’s test credential:
