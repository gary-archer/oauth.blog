...
My only motivation for activating advanced features is to enable *Access Token Customization* and issue fields from the user schema as claims. This is an essential OAuth behaviour for protecting data in APIs.
