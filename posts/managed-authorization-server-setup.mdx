...
The basic configuration was described in the earlier post on choosing an <Link href='/posts/oauth-infrastructure-setup'>Initial Authorization Server</Link>. This included creating a user schema with some custom fields to use for authorization.
