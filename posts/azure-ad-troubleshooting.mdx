...
- <Link href='/posts/basicspa-codingkeypoints'>SPA 1 – Code Details</Link>
- <Link href='/posts/basicapi-codingkeypoints'>SPA 2 – Code Details</Link>
