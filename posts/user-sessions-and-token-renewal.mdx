...
| <span style={{color:'red'}}>Refresh Tokens in Local Storage</span> | If you store refresh tokens in local storage, you can avoid the use of SSO cookies and get a new access token with a simple Ajax request from JavaScript. |
...
- I summarize <Link href='/posts/logout'>Logout</Link> behaviours as part of your SPA's session management.
