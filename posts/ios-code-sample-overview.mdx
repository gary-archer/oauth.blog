...
Previously we covered <Link href='/posts/android-coding-key-points'>Android Code Details</Link> for our initial mobile app. Next we will provide the same OAuth secured app for iOS, using Xcode and SwiftUI, with AppAuth libraries and a modern coding style. The app connects to <Link href='/posts/cloud-hosting'>HTTPS endpoints hosted in AWS</Link>, so that you only need to run the mobile app's code to get a fully integrated solution.
...
<div className="smallimage">
![aswebauthenticationsession start](/images/540/aswebauthenticationsession-start.jpg?v=20240914)
</div>
...
<div className="smallimage">
![aswebauthenticationsession login](/images/540/aswebauthenticationsession-login.jpg?v=20240914)
</div>
...
<div className="smallimage">
![prerequisite screen](/images/540/prerequisite-screen.jpg?v=20240914)
</div>
...
<div className="smallimage">
![expiry testing](/images/540/expiry-testing.jpg?v=20240914)
</div>
...
<div className="smallimage">
![logout prompt](/images/540/aswebauthenticationsession-start.jpg?v=20240914)
</div>
...
<div className="smallimage">
![not found login response](/images/540/not-found-login-response.jpg?v=20240914)
</div>
...
<div className="smallimage">
![login intermediate page](/images/540/login-intermediate-page.jpg?v=20240914)
</div>

<div className="smallimage">
![logout intermediate page](/images/540/logout-intermediate-page.jpg?v=20240914)
</div>
