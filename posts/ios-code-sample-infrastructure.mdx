...
| <span style={{color:'green'}}>**www.authsamples.com**</span> | We use the web domain for ad-hoc hosting of HTML files, including interstitial post-login and post-logout web pages |
...
- Next we will describe some <Link href='/posts/ios-code-sample-coding-key-points'>iOS Code Overview</Link>
