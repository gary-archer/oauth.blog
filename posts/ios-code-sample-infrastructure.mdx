...
| <span style={{color:'green'}}>**www.authsamples.com**</span> | We use the web domain for ad-hoc hosting of HTML files, including intermediate post-login and post-logout web pages |
