...
For each of this blog’s UI and API code samples, an *Error Codes* module lists all of the known error codes. This provides a full list of error codes and can be published to interested parties when required.
