...
Previously we discussed <Link href='/posts/final-desktop-app-coding-key-points'>Code Overview</Link> for the final desktop code sample. Next we will get a basic Android OAuth setup working, by running the AppAuth Android code sample.
