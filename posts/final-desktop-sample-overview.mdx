...
| ---------------- | --------------- |
| <span style={{color:'green'}}>**Windows**</span> | start x-mycompany-desktopapp:/companies/2 |
| <span style={{color:'green'}}>**macOS**</span> | open x-mycompany-desktopapp:/companies/2 |
| <span style={{color:'green'}}>**Linux (Gnome)**</span> | xdg-open  x-mycompany-desktopapp:/companies/2 |
